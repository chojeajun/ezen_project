...
<form name="frm" method="post">
	...
	<table id="orderList"> <!-- 게시물의 내용 -->
		...
		<tr><th width="20%">제목</th><td align="left">${qnaVO.subject} ${qnaVO.REPYN}</td>
		<td style="text-align:center;  padding-right:0px;">${QNAVO.SUBJECT}</td></tr>
	...
	<c:choose>          
		<c:when test='${qnaVO.REPYN=="1"}'> <!-- 관리자 답변 전 표시 -->
			<table id="qnaList">

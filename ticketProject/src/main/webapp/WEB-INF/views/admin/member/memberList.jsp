...
<table style= "margin-left: 655px;">
	...
	<input class="btn3" type="button" value="검색" onclick="go_search('memberList')">
	<input class="btn6" type="button" name="btn_total" value="전체보기 " onClick="go_total('memberList')"></td> </tr>
</table><br>

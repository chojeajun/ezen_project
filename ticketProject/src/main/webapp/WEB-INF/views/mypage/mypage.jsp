...
<div id="mypage_box">
	...
	<form method="post" name="mypageForm" id="mypageactionFrm">
		<h2 id="legend">${ loginUser.MSEQ }번${ loginUser.MAME }회원님의 정보</h2>
		<fieldset id="mypagefield">
          ...
          수정을 금지시킴  -->
			...
			<br /> <label>이름</label> <input type="text" name="name"
				value="${ loginUser.NAME }" readonly /> <br />
		...
		<div id="buttons" style="margin-left: 600px;">
			<input type="button" value="신청 내역"
				onClick="location.href='myOrderView'"
			...
			<input type="button" value="대리 내역"
				onClick="location.href='myRegister'"

...
<!-- 				</tr>		 -->
				...
				<c:forEach items="${ replyList }" var="reply">
					<tr align="center" style="height:30px;">
						...
						<td style="line-height:30px;">
								<input type="button" value="삭제" onclick="location.href='ticket.do?command=adminReviewReplyDelete&repseq=${ reply.repseq }&rseq=${ reviewVO.rseq }'">
						</td>
					</tr>
				</c:forEach>
			</table>
			...
			<div class="rev_btn_box btn_box" style="float: left">
				<input type="button" value="메인으로" class="cancel" onClick="location.href='ticket.do?command=adminReviewList'">
			</div>
		</form>
	</div>
</div>
